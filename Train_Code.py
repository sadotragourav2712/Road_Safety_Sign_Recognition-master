...
def myModel(image_dimensions, no_of_classes):
    no_of_filters = 60
    size_of_filter = (5, 5)
    size_of_filter2 = (3, 3)
    size_of_pool = (2, 2)
    ...
    model = Sequential()
    model.add(Conv2D(no_of_filters, size_of_filter, input_shape=(image_dimensions[0], image_dimensions[1], 1),
                     activation='relu'))
...
#Model Training
model = myModel(imageDimesions, noOfClasses)
print(model.summary())
